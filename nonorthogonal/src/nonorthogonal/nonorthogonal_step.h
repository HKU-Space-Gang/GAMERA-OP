...
/*
 * Inner radial hard-wall guard: prevent numerical reconstruction from
 * injecting mass and positive energy into the active domain. Momentum and
 * Maxwell fluxes are untouched.
 */
...
/* Pressure control for low-density, Boris-limited magnetospheres. */
